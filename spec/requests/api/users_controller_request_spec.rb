...
describe 'Api/V1/UsersController', type: :request do
  context 'GET' do
    ...
    it 'user show fail' do
      user = User.create(email: 'jonh@doe.com', password: '123456789')
      get "http://localhost:3000/api/v1/users/#{user.id * 100}"
  ...
  context 'PATCH' do
    ...
    it 'user not found for update' do
      user = User.create(email: 'jonh@doe.com', password_digest: '123456789')

      patch "http://localhost:3000/api/v1/users/#{user.id * 100}", params: { user: { email: 'teste@teste.com' } }
